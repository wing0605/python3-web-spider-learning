...
def parse_detail(html) -> dict:
    ...
    #         <img data-v-63864230="" src-old="https://p0.meituan.net/movie/ce4da3e03e655b5b88ed31b5cd7896cf62472.jpg
    #         @464w_644h_1e_1c" class="cover">
    #       </a>
    #     </div>
    #   </div>
    cover_pattern = re.compile('class="item.*?<img.*?src-old="(.*?)".*?class="cover">', re.S)
